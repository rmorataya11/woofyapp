...
class _AppointmentsScreenState extends ConsumerState<AppointmentsScreen>
  ...
  void _addNewAppointment() {
    showDialog(
      context: context,
      builder: (context) => _NewAppointmentDialog(
...
class _NewAppointmentDialog extends ConsumerStatefulWidget {
  ...
  const _NewAppointmentDialog({required this.onAppointmentCreated});
...
// Diálogo para editar/reagendar cita
          ...
          children: [
            ...
            Container(
              ...
              child: Row(
                children: [
                  Icon(
                    widget.isReschedule ? Icons.event_repeat : Icons.edit,
                    color: Colors.white,
                    size: 28,
                  ),
                  const SizedBox(width: 12),
                ...
                children: [
                  ...
                  ElevatedButton.icon(
                    ...
                    label: Text(
                      _isSubmitting
                          ? 'Guardando...'
                          : (widget.isReschedule ? 'Reagendar' : 'Guardar'),
                      style: const TextStyle(color: Colors.white),
                    ),
                    style: ElevatedButton.styleFrom(
                      backgroundColor: Theme.of(context).colorScheme.primary,
